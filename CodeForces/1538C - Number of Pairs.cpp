...
//     for (int i = 0; i < n - 1; i++)
//     {
//         ll a = lower_bound(v.begin() + i + 1, v.end(), l - v[i]) - v.begin();
//         ll b = upper_bound(v.begin() + i + 1, v.end(), r - v[i]) - v.begin();
//         ans += (b - a);
//     }
//     cout << ans << nl;
// }

/* -------------- Sol 2 : Using 2 Pointers -------------- */
void solve()
{
    re(n, l, r);
    reV(v, n);
