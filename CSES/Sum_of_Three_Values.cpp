...
//         {
//             ll t = k - v[i].first - v[j].first;
//             auto comp = [&](pair<ll, ll> &a, ll b)
//             {
//                 return a.first < b;
//             };
//             auto it = lower_bound(v.begin() + j + 1, v.end(), t, comp);
...
//         {
//             ll t = k - v[i].first - v[j].first;
//             auto it = lower_bound(v.begin() + j + 1, v.end(), make_pair(t, 0LL));
//             if (it != v.end() && (*it).first == t)
//             {
//                 ans.push_back(v[i].second);
//                 ans.push_back(v[j].second);
...
void solve()
{
    ...
    for (int i = 0; i < n - 2; i++)
    {
        ...
        {
            ll t = k - v[i].first - v[j].first;
            while (r > j && v[r].first > t)
                r--;
            if (v[r].first == t && r > j && r < n)
            {
                ans.push_back(v[i].second);
                ans.push_back(v[j].second);
