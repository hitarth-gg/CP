    ...
    for (int i = n - 2; i >= 0; i--)
    {
        for (int j = 0; j < m; j++)
        {
            if (v[i][j] == 'X')
            {
                for (int k = 0; k < m; k++)
                {
                    if (v[i + 1][k] == 'X' && dist(i, j, i + 1, k) <= s * s)
                    {
        ...
        for (int j = 0; j < m; j++)
        {
            if (v[i][j] == 'X')
            {
                for (int k = 0; k < m; k++)
                {
                    if (k != j && v[i][k] == 'X' && dist(i, j, i, k) <= s * s)
                    {
                        tempHorizontal[j] = mod_add(tempHorizontal[j], dp[i][k]);
                    }
                }
            }
        }
