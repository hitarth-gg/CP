...
void solve() // Didn't submit because codechef disabled the submit button for this problem
{
    ll sideSquare = 2 * leftist(0);
    ll triangleHeight = uptist(0) - sideSquare;
    ll baseTriangle = 2*leftist(sideSquare);

    cout << sideSquare*sideSquare + baseTriangle*triangleHeight/2; 
}
